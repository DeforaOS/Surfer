...
"Copyright © 2012-2016 Pierre Pronchery <khorben@defora.org>";
...
static void _helper_on_help_contents(gpointer data)
{
	...
	helper_open_manual(helper, "1", PROGNAME_HELPER, MANDIR);
}
#endif
